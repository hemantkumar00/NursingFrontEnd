...
import Create_UpdateQuestion from "./Create_UpdateQuestion";
...
const TestLoadingPage = () => {
  ...
  async function loadSingleTest() {
    ...
    try {
      ...
      const response = await axios.get(`${API}/testseries/${testId}/view`, {
      ...
      {isLoading ? (
        ...
        test && (
          <div className="my-5">
            ...
            >
              {openAddQuestion && (
                <Create_UpdateQuestion hitRelaoad={hitRelaoad} />
              )}
            </div>
